...
with open("C:/Users/eevee/Cal Poly/Vanessa Christine Veto - Redo Twitter Data/Plots_PNG/Maps/TweetsPerCountryDEEP2.html", 'r') as f:
        html_string = f.read()
...
with open("C:/Users/eevee/Cal Poly/Vanessa Christine Veto - Redo Twitter Data/Plots_PNG/Maps/AccountsPerCountryDEEP.html", 'r') as f:
        html_string = f.read()
components.v1.html(html_string, width=1000, height=400, scrolling=False)
